...
## NextJS Folder Structure Overview
In NextJS app router, it is an industry convention to have the following folder names.
...
- **/app/ui**  
  ...
  To save time, these components are pre-styled for you.

- **/public**  
  Contains all the static assets for your application, such as images.

- **Config Files**  
  You'll also notice config files such as `next.config.ts` at the root of your application.  
